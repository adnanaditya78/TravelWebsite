      ...
      <div className='col-6'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className='mb-3'>
            ...
            <input type='number' className='form-control' id='price_discount' name='price_discount' value={price_discount} onChange={handleChange} required />
          </div>
          <div className='mb-3'>
            <label htmlFor='rating' className='form-label'>
              Rating
            </label>
            <input type='number' className='form-control' id='rating' name='rating' value={rating} onChange={handleChange} required />
          </div>
          <div className='mb-3'>
            <label htmlFor='total_reviews' className='form-label'>
              Total Reviews
            </label>
            <input type='number' className='form-control' id='total_reviews' name='total_reviews' value={total_reviews} onChange={handleChange} required />
          </div>
          <div className='mb-3'>
