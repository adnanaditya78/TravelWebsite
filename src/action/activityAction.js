...
export const deleteActivity = (bannerId) => {
  return (dispatch) => {
    axios
      .delete('https://travel-journal-api-bootcamp.do.dibimbing.id/api/v1/delete-activity/' + bannerId, {
        headers: {
...
export const addActivity = ({ categoryId, title, description, getUrl, price, price_discount, rating, total_reviews, facilities, address, province, city, location_maps }) => {
  return (dispatch) => {
    axios
      .post(
...
export const updateActivity = ({ activityId, categoryId, title, description, imageUrls, price, price_discount, rating, total_reviews, facilities, address, province, city, location_maps }) => {
  return (dispatch) => {
    axios
      .post(
